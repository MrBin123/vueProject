  ...
  <div id="postage-alls">
      <div id="postage-all">
        <div id="postage-all-top">
            ...
            <li v-for="(v,i) in postagesall" :key="i" @click="goodslist(v.id,i)" :class="{active: i == index}"><p>{{v.name}}</p><mt-badge size="small" type="error">{{v.goodsnum}}</mt-badge></li> 
        
          </ul>
          <ul id="content">
            <li v-for="(v,i) in contents"  :key="i" @click="refresh(v.id,v.name)"><p>{{v.name}}</p><span>{{v.goodsnum}}</span></li> 
