          ...
          <ul id="shop">
              <li v-for="(v,i) in result" :key="i" @click="toDetail(v)">
                ...
                <div>
                  <p>{{v.title}}</p>
                  <span>{{v.webdes}}</span>
                  <b><span><img src="../imgs/kwzlist_time.png"></img>{{v.createdate.split(" ")[0]}}</span><span><img src="../imgs/kwzlist_zan.png"></img>{{v.goodnum}}</span><span><img src="../imgs/kwzlist_dian.png"></img>{{v.hits}}</span></b>
                </div>
              </li>
          </ul>
                    ...
                    span{
                     ...
                     &:nth-child(1){
                        ...
                        img{
                          ...
                          width: 12px;
                          height: 12px;
                          // background: url('../imgs/kwzlist_time.png');
                          // background-size: 100%;
                          border: none;
                          margin-bottom: 4px;
                          margin-right: 4px;
