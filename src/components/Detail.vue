<template>
  <div class="detailbox">
    ...
    <div class="footer">
      <ul class="foot">
        <li class="small" @click="gohome">
          <img src="../imgs/goodsdetail_dp_red.png" />
          <p class="first">首页</p>
        </li>
        <li class="small" :class="{act : act == 2}" @click="collect(2)">
          <img src="../imgs/goodsdetail_sc.png" />
          <p class="notfirst">收藏</p>
        </li>
        <li class="small">
          <img src="../imgs/goodsdetai_cart.png" />
          <p class="notfirst">购物车</p>
        </li>
        <li class="cart">
          <p>加入购物车</p>
        </li>
