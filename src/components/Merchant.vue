    ...
    <mt-loadmore :bottom-method="loadBottom" @bottom-status-change="handleBottomChange" ref="loadmore">
      ...
      <div class="introduce">
        ...
        <div class="navagation">
          <p class="parti">
            <span>已参与：</span>{{resdata.sellgoodsnum}}</p>
          <p class="loc">
            <img src="../imgs/location_marker.png" />{{resdata.city}}</p>
          <p class="gps">
            <a>一键导航</a>
          </p>
        </div>
        <div class="kuang">
          <div class="s-left">
            <p>
              <span>编
                <a>你</a>号：</span>{{resdata.id}}</p>
            <p>
              <span>服务商：</span>{{resdata.name}}</p>
            <p>
              <span>等
                <a>你</a>级：</span>
              <img :src="resdata.levelimg">
            </p>
            <p>
              <span>地
                <a>你</a>址：</span>{{resdata.fulladdr}}</p>
          </div>
          <div class="s-right">
            <a>进入店家</a>
            <a>联系商家</a>
