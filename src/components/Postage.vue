<template>
  <div id="postage">
    ...
    <ul id='nav'>
      <li @click="change(0)" :class="index" v-if="claid">
        <p>{{claid}}</p>
        <b></b>
      </li>
      <li @click="change(0)" :class="index" v-else>
        <p> {{selectAll}}</p>
        <b></b>
      </li>
      <li @click="change(1)" :class="index">
        <p>全国</p>
        <b></b>
      </li>
      <li @click="change(2)" :class="index">
        <p>销量</p>
        <b></b>
        </img>
      </li>
      <li @click="change(3)" :class="index">
        <p>价格</p>
        <b></b>
      </li>
      <li @click="change(4)" :class="index">
        <p>积分</p>
        <b></b>
      </li>
    </ul>
